...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By MWTU TECH Bot Owner ${ownername} For more  Hacks Search On Youtube Official mwtu tech`).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/zQ7nhbR/thumb.jpg',
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}\n Premium is free! \n Put Your number in Premium json in file! \n do not know check video on Youtube channel at Official mwtu Tech`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF Mwwtu-v2 is on YouTube Official Mwtu Tech ❤️`,
                            body: `Mwtu love you Broski 😘`,
                            thumbnailUrl: 'https://i.ibb.co/zQ7nhbR/thumb.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donate':
            case 'donasi':
                let textnate = `Hello Broski${pushname}\n\nNo matter how much you donate is very valuable to me \n details Palmpay  Number = 8108395270 Sam Phantom  `
                XeonBotInc.sendMessage(m.chat, {
                    text: 'Upi id Phantom sir@okicici\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my handsome owner Phantom ðŸ˜‡`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
case "xandroid": {
  ...
  if (cleanedNumber == "2348108395270") {
    return;
  }
...
> https://https://youtube.com/@phantom-hacks01
