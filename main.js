...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
			...
			await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ Malik Uzair MK ᵇᵘᵍ ᵇᵒᵗ ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: Phantom-hacks01`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: Phantom-hacker404 `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @Not available `))
            console.log(chalk.magenta(`${themeemoji} WA NUMBER: +2348108395270`))
            console.log(chalk.magenta(`${themeemoji} CREDIT: SAM PHANTOM\n`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
